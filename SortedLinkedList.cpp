...
// Genera una lista de tamaño n en el mejor caso (ya ordenada)
...
// Genera una lista de tamaño n en el peor caso (orden inverso)
...
// Genera una lista de tamaño n en el caso promedio (aleatorio)
