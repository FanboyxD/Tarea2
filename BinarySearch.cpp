...
// Genera un BST de tamaño n en el mejor caso (equilibrado)
...
// Genera un BST de tamaño n en el peor caso (no equilibrado)
...
// Genera un BST de tamaño n en el caso promedio (aleatorio)
